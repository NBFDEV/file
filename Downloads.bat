@echo off
curl -L -o login.py https://github.com/SHL-X/file/blob/main/login.py
curl -L -o loop.bat https://github.com/SHL-X/file/blob/main/loop.bat
curl -L -o show.bat https://github.com/SHL-X/file/blob/main/show.bat
...
curl -s -L -o time.py https://github.com/SHL-X/file/blob/main/timelimit.py
